...
public class FirstContactRouter extends ActiveRouter {
	...
	protected void transferDone(Connection con) {
		/* @julianofischer
		 * O método messageTransferred é chamado depois de transferDone
		 * como esse roteador deleta a mensagem que fica e no método
		 * messageTransferred eu preciso dela para atualizar o valor de
		 * timeforwarded (LRF), vou precisar de algum outro artifício
		 * para mudar o valor de TimeForwarded.
		 */
