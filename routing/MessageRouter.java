...
public abstract class MessageRouter {
	...
	public static final int Q_MODE_ROUND_ROBIN = 3;
					...
					new Comparator() {
						...
						public int compare(Object arg0, Object arg1) {
							...
							if (arg0 instanceof Tuple) {
								m1 = ((Tuple<Message, Connection>)arg0).getKey();
								m2 = ((Tuple<Message, Connection>)arg1).getKey();
							}
							...
							if(m1.getGlobalNumberOfReplicas()>m2.getGlobalNumberOfReplicas()){
								return 1;
							}else if(m1.getGlobalNumberOfReplicas()<m2.getGlobalNumberOfReplicas()){
								return -1;
							}else{
