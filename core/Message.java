...
public class Message implements Comparable<Message> {
	...
	/** utilizado na política LRF */
	private double timeForwarded;
	
	/** utilizado na política MOFO
	 *  MOFO LOCAL: quando a mensagem é enviada para outro nó
	 *  a variável numberOfReplicas é configurada como zero.
	 *  MOFO GLOBAL: quando a mensagem é replicada, a variável
	 *  numberOfReplicas é replicada junto.
	 */
	private int localNumberOfReplicas;
	private int globalNumberOfReplicas;
	private double higherDeliveryProb = 0.0;
	...
	public Message(DTNHost from, DTNHost to, String id, int size) {
		...
		//@julianofischer
		this.timeForwarded=-1.0;
		this.localNumberOfReplicas = 0;
		this.setGlobalNumberOfReplicas(0);
		this.setHigherDeliveryProb(0.0);
	...
	protected void copyFrom(Message m) {
		...
		//@julianofischer
		/* O número de réplicas global é "transferido" para a mensagem
		 * que foi replicada, entretanto, o número local não é transferido
		 * e deve começar como 0 novamente.*/
		this.setGlobalNumberOfReplicas(m.getGlobalNumberOfReplicas());
		this.setTimeForwarded(m.getTimeForwarded());
		
		//política drop most probably delivered first
		//this.setHigherDeliveryProb(m.getHigherDeliveryProb());
	...
	public void setTimeForwarded(double timeForwarded) {
		this.timeForwarded = timeForwarded;
	}

	public double getTimeForwarded() {
		return timeForwarded;
	}

	public void setLocalNumberOfReplicas(int localNumberOfReplicas) {
		this.localNumberOfReplicas = localNumberOfReplicas;
	}

	public int getLocalNumberOfReplicas() {
		return localNumberOfReplicas;
	}

	public void setGlobalNumberOfReplicas(int globalNumberOfReplicas) {
		this.globalNumberOfReplicas = globalNumberOfReplicas;
	}

	public int getGlobalNumberOfReplicas() {
		return globalNumberOfReplicas;
	}

	public double getHigherDeliveryProb() {
		return higherDeliveryProb;
	}

	public void setHigherDeliveryProb(double higherDeliveryProb) {
		this.higherDeliveryProb = higherDeliveryProb;
	}
